...
exports.default = (plugin) => {
    ...
    plugin.controllers.user.find = async (ctx) => {
        ...
        const response = await strapi.entityService.findMany("plugin::users-permissions.user", {
            populate: "deep,3",
        });
        const users = response.map(({ id, username, email, confirmed, blocked, createdAt, updatedAt, firstName, lastName, phone, role, avatar, delivery, history, }) => {
            var _a;
            return ({
                id,
                username,
                ...
                historyCount: ((_a = history === null || history === void 0 ? void 0 : history.books) === null || _a === void 0 ? void 0 : _a.length) || 0,
            });
        }) || [];
        return users;
    };
